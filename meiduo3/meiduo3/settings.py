"""
Django settings for meiduo3 project.
...
SECRET_KEY = '+#y2=m9s!b92!zc$$ll2zlxkjg+#x&ipxecxzzb*1)=^93ovxd'
...
WSGI_APPLICATION = 'meiduo3.wsgi.application'
